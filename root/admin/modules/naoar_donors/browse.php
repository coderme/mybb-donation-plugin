...
#  This file will be used for managing donations
...
$page->add_breadcrumb_item($lang->naoardonate_global_browse, "index.php?module=naoar_donors{$sep}browse");
$page->extra_header=<<<NAOAR_HEADER
<style type="text/css">
.naoartable {
...
<div style="float:right"><form action="index.php?module=naoar_donors{$sep}browse" method="post">
<input type="hidden" name="my_post_key" value="$mybb->post_code" />
<input type="hidden" name="naoar_cookie" value="inlinemod_donor1" />
<input type="hidden" name="naoar_referrer" value="index.php?module=naoar_donors{$sep}browse" />
...
<input type="hidden" name="naoar_referrer" value="index.php?module=naoar_donors{$sep}browse&action=unconfirmed" />
<span class="smalltext"><strong>$lang->naoardonate_browse_inline_moderation</strong></span>
<select name="inline_action">
		<option value="multidelete" >$lang->naoardonate_browse_delete</option>
		<option value="multiconfirm" selected="selected" >$lang->naoardonate_browse_confirm</option>
...
<input type="hidden" name="naoar_referrer" value="index.php?module=naoar_donors{$sep}browse&action=confirmed" />
<span class="smalltext"><strong>$lang->naoardonate_browse_inline_moderation</strong></span>
<select name="inline_action">
		<option value="multidelete" >$lang->naoardonate_browse_delete</option>
