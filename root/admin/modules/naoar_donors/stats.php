...
#  Naoar Donation v2.0 for mybb 1.4x, 1.6x
#  This file will be used for displaying donors' statistics
...
$page->add_breadcrumb_item($lang->naoardonate_global_stats, "index.php?module=naoar_donors-stats");
...
'ZWL' => $lang->naoardonate_global_currency_zwl
	...
	print "<table cellspacing=\"0\"  class=\"naoar_table\">
	<tr valign=\"top\">
		<td><div class=\"naoar_div\">$lang->naoardonate_stats_total_donations :</div>";

	if($total)
	{
	print "<ul>". ( $confirmedtotal ? "<li class=\"green\">$lang->naoardonate_stats_confirmed : $confirmedtotal</li>" : '') . ( $notconfirmedtotal ? "<li class=\"red\">$lang->naoardonate_stats_unconfirmed : <a href=\"index.php?module=naoar_donors{$sep}browse&action=unconfirmed\" style=\"color:red;text-decoration:underline\" >$notconfirmedtotal</a></li>": '' ) .( $total? "<li class=\"navy\">$lang->naoardonate_stats_total : $total</li>" : '' ). "</ul>";
	}
	else
	{
	print '<div style="padding:27px;text-align:left">' . $lang->naoardonate_stats_notyet . '</div>';
	}
	print "</td><td><div class=\"naoar_div\">$lang->naoardonate_stats_guests_donations :</div>";
	...
	print "</td></tr><tr valign=\"top\"><td><div class=\"naoar_div\">$lang->naoardonate_stats_members_donations :</div>";
	...
	print "</td><td><div class=\"naoar_div\">$lang->naoardonate_stats_amount :</div>";
	...
	print "</td></tr><tr valign=\"top\"><td><div class=\"naoar_div\">$lang->naoardonate_stats_topcurrencies :</div>";
	...
	print "</td><td><div class=\"naoar_div\">$lang->naoardonate_stats_topamounts :</div>";
	...
	print "</td></tr><tr valign=\"top\"><td><div class=\"naoar_div\">$lang->naoardonate_stats_toppayment_methods :</div>";
	...
	print "</td><td><div class=\"naoar_div\">$lang->naoardonate_stats_topgroups :</div>";
	...
	$page->output_footer();
		...
		$table =<<<TABLE_HEAD
		<table cellspacing="0" class="naoar_donors">
	<tr>
...
new PopupMenu('note_$donor[did]');
	...
	<tr>
		...
		<td align="center">$donor[payment_method]</td>
		<td align="center">$donor[ip]</td>
		<td align="center"><div class="naoar_info"><div>$email</div><div>$note</div></div></td>
		<td align="center">$donor[dateline]</td>
			</tr>
TABLE_BODY;
		}
